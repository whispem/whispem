...
<strong>I build programming languages and low-level systems — from the grammar down to the syscall.</strong>

<em>Rust, assembly, and a stubborn need to understand how things really work.</em>
...
**[minikv](https://github.com/whispem/minikv)** — a distributed key-value & object store in Rust: Raft, 2PC, write-ahead log, virtual sharding, S3-compatible API. Understanding over raw speed.

**[sussurro.cpp](https://github.com/whispem/sussurro.cpp)** — offline voice-to-voice translation across four languages, reimplemented on ggml. No server, no network. *Sussurro* is Italian for whisper.

**[asm.fm](https://github.com/whispem/asm.fm)** — a chiptune synthesizer in pure x86-64 assembly. No libc, no audio library — just the CPU and 44100 numbers a second.
