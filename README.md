...
**Curious Technologist · Systems-Oriented · Rust Learner**

I like building small, well-defined systems that make sense — the kind where every piece has a purpose and the whole thing feels clean, lightweight, and intentional.
...
## 🛠️ What I Enjoy Working With

- **Languages:** Rust 🦀 · Swift · SwiftUI  
- **Focus Areas:** small-scale storage systems · data models · predictable state flow  
- **Design Interests:** UI/UX · visual clarity · intuitive representations  
...
## ⭐ Featured Project — mini-kvstore-v2
...
## 🧪 Earlier Iterations & Related Work
...
🔗 https://github.com/whispem/mini-kvstore

### **CSV-Key-Value-Store**  
A lightweight experiment using CSV as a persistence layer — great for understanding abstraction boundaries.  
🔗 https://github.com/whispem/CSV-Key-Value-Store
...
🔗 https://github.com/whispem/DNA-Helix-3D-Visualization

### **LunarView**  
A small, peaceful exploration of lunar motion and lighting.  
🔗 https://github.com/whispem/LunarView
...
My goal is to build tools that are minimal, reliable, and well-documented — systems that make sense.
...
*I appreciate systems that feel balanced — where complexity quietly resolves into something clean, minimal, and genuinely thoughtful.*
